...
import { setParticipantPassword } from '@/api/authApi';
import { useParticipantSession } from '@/contexts/ParticipantSessionContext';
import { toast } from 'sonner';

const ParticipantSetPassword: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const result = await setParticipantPassword(setupToken, password, confirmPassword);
          ...
          <CardHeader className="space-y-4 pb-2 text-center">
            ...
            <div>
              ...
              <CardDescription className="mt-2 text-gray-500">
                Create a password to access your Neomora participant portal.
              </CardDescription>
            </div>
          </CardHeader>
...
export default ParticipantSetPassword;
