 ...
 interface TeamDelegationFilterProps {
 ...
 export const TeamDelegationFilter: React.FC<TeamDelegationFilterProps> = ({
   ...
   // Get unique countries from delegations
   const countries = [...new Set(delegations.map(d => d.country))];
 
   return (
     <div className="flex items-center gap-3">
       {/* Delegation/Country Selector */}
